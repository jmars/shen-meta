...
(define interp { zinc-code --> zinc-value --> (list zinc-value) --> (list zinc-value) --> (list zinc-value) --> zinc-value }
  ...
  [prim cn | C] [string A] E [[string A1] | S] R                -> (interp C [string (apply cn [A A1])] E S R)
  [prim cn | C] A E [A1 | S] R                                   -> (interp C [string (apply cn [(extract-kl A) (extract-kl A1)])] E S R)
  ...
  [prim get-time | C] [symbol A] E S R                          -> (interp C [number (apply get-time [A])] E S R)
  [prim eval-kl | C] A E S R                                    -> (interp C (toplevel-interp (kl->zinc (extract-kl A))) E S R)
  [prim close | C] [stream in A] E S R                          -> (interp C (do (apply close [A]) [cons]) E S R)
  [prim close | C] [stream out A] E S R                         -> (interp C (do (apply close [A]) [cons]) E S R)
  [prim read-byte | C] [stream in A] E S R                      -> (interp C [number (apply read-byte [A])] E S R)
  ...
  [prim absvector | C] [number A] E S R                         -> (interp C [absvector (apply absvector [A])] E S R)
  [prim absvector? | C] [absvector _] E S R                     -> (interp C [boolean true] E S R)
  [prim absvector? | C] A E S R                                 -> (interp C [boolean false] E S R)
  [prim n->string | C] [number A] E S R                         -> (interp C [string (apply n->string [A])] E S R)
  [prim string->n | C] [string A] E S R                         -> (interp C [number (apply string->n [A])] E S R)
  [prim str | C] [symbol A] E S R                               -> (interp C [string (apply str [A])] E S R)
  [prim str | C] [number A] E S R                               -> (interp C [string (apply str [A])] E S R)
  ...
  [prim str | C] A E S R                                        -> (interp C [string (apply str [A])] E S R)
  [prim tlstr | C] [string A] E S R                             -> (interp C [string (apply tlstr [A])] E S R)
  [prim hdstr | C] [string A] E S R                             -> (interp C [string (apply hdstr [A])] E S R)
  [prim read-file-as-string | C] [string A] E S R               -> (interp C [string (apply read-file-as-string [A])] E S R)
  ...
  [prim value | C] [symbol A] E S R                             -> (interp C (apply value [A]) E S R)
  [prim intern | C] [string A] E S R                            -> (interp C [symbol (apply intern [A])] E S R)
  [prim error-to-string | C] [error A] E S R                    -> (interp C [string (apply error-to-string [A])] E S R)
  ...
  [prim = | C] A E [A1 | S] R                                   -> (interp C [boolean (apply = [A A1])] E S R)
  [prim open | C] [string A] E [[symbol in] | S] R              -> (interp C [stream in (apply open [A in])] E S R)
  [prim open | C] [string A] E [[symbol out] | S] R             -> (interp C [stream out (apply open [A out])] E S R)
  [prim write-byte | C] [number A] E [[stream out A1] | S] R    -> (interp C [number (apply write-byte [A A1])] E S R)
  ...
  [prim <-address | C] [absvector A] E [[number A1] | S] R      -> (interp C (apply <-address [A A1]) E S R)

  [prim pos | C] [string A] E [[number A1] | S] R               -> (interp C [string (apply pos [A A1])] E S R)
  [prim <= | C] [number A] E [[number A1] | S] R                -> (interp C [boolean (apply <= [A A1])] E S R)
  [prim >= | C] [number A] E [[number A1] | S] R                -> (interp C [boolean (apply >= [A A1])] E S R)
  [prim > | C] [number A] E [[number A1] | S] R                 -> (interp C [boolean (apply > [A A1])] E S R)
  [prim < | C] [number A] E [[number A1] | S] R                 -> (interp C [boolean (apply < [A A1])] E S R)
  [prim set | C] [symbol A] E [A1 | S] R                        -> (interp C (apply set [A A1]) E S R)
  ...
  [prim - | C] [number A] E [[number A1] | S] R                 -> (interp C [number (apply - [A A1])] E S R)
  [prim * | C] [number A] E [[number A1] | S] R                 -> (interp C [number (apply * [A A1])] E S R)
  [prim / | C] [number A] E [[number A1] | S] R                 -> (interp C [number (apply / [A A1])] E S R)
  [prim + | C] [number A] E [[number A1] | S] R                 -> (interp C [number (apply + [A A1])] E S R)
  [prim address-> | C] [absvector A] E [[number A1] A2 | S] R   -> (interp C [absvector (apply address-> [A A1 A2])] E S R)
  [] A E S R                                                    -> A
